...
def process_image():
    ...
    if index == 0:
        result_e = {'title': '차량 화재 긴급 신고', 'category_index': int(index)}
    elif index == 1:
        result_e = {'title': '건물 화재 긴급 신고', 'category_index': int(index)}
    elif index == 2:
        result_e = {'title': '산불 화재 긴급 신고', 'category_index': int(index)}
    elif index == 3:
        result_e = {'title': '교통 사고 긴급 신고', 'category_index': int(index)}
    else:
